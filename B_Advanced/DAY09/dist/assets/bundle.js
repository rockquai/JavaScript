...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! ./es6-jQuery */ 1);
	...
	// [Sass] --------------------------------------------------------------------------
	__webpack_require__(/*! ./sass/app.sass */ 3);
	
	// [JS] ---------------------------------------------------------------------------
	// 의존 모듈(square, factorial) 로드
	// server side javascript env. module load
	// CommonJS 방법 모듈 로드 require() 함수 사용
	var square = __webpack_require__(/*! ./modules/square */ 7);
	var factorial = __webpack_require__(/*! ./modules/factorial */ 8);
	var capitalize = __webpack_require__(/*! ./modules/capitalize */ 9);
	var camelCase = __webpack_require__(/*! ./modules/camelCase */ 10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function init() {
	  ...
	  // <nav> 내부의 <a> 요소들 참조
	  var $ul_links = $ul.find('a');
	  // <nav> 내부의 <a> 요소들 순환 이벤트 바인딩(연결)
	  $ul_links.each(function (idx, item) {
	    // $link 변수에 필터링 된 $(<a>) 참조
	    var $link = $ul_links.eq(idx);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__(/*! !./../../../~/css-loader!./../../../~/sass-loader!./app.sass */ 4);
...
/* 4 */
/*!**************************************************************!*\
  !*** ./~/css-loader!./~/sass-loader!./src/app/sass/app.sass ***!
  \**************************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "@charset \"UTF-8\";\nhtml {\n  -webkit-font-smoothing: antialiased;\n  text-shadow: 1px 1px 1px rgba(0, 0, 0, 0.004);\n  font-size: 10px; }\n\nbody {\n  margin: 0;\n  font-size: 1.6rem; }\n\na {\n  text-decoration: none; }\n\nul, ol {\n  list-style: none; }\n\n.container {\n  width: 1200px;\n  margin-left: auto;\n  margin-right: auto; }\n\n.row::after {\n  content: '';\n  display: block;\n  clear: both; }\n\n[class*=\"col-\"] {\n  float: left;\n  margin-left: 1rem;\n  margin-right: 1rem; }\n\n.col-1 {\n  width: 80px; }\n\n.col-2 {\n  width: 160px; }\n\n.page {\n  height: 150vh;\n  background: rgba(233, 255, 18, 0.7); }\n  .page h1 {\n    color: #D700FF;\n    font-size: 3rem; }\n  .page .wrapper {\n    padding: 1rem; }\n  .page .javascript-library-frameworks {\n    margin-top: 0;\n    padding-left: 0; }\n    .page .javascript-library-frameworks li::before {\n      content: '\\2501   '; }\n    .page .javascript-library-frameworks a {\n      display: inline-block;\n      padding: 0.4em;\n      color: #5F0A5E; }\n", ""]);
...
/***/ function(module, exports) {
	...
	function camelCase(s) {
	  return s.split(' ').map(function (k, i) {
	    if (i === 0) {
	      return k;
	    }
	    return k.replace(/^./, function ($1) {
