...
this.DOM_Helper = (function(global){
  ...
  function makeArray(like_arr_obj) {
    ...
    // 방법 2-1. 네이티브 배열의 기술을 활용
    // return Array.prototype.slice.call(like_arr_obj, 0);

    // 방법 2-2. 네이티브 배열의 기술을 활용 (`방법 2-1`와 같은 코드다.)
    // jQuery.makeArray()와 같은 기능.
...
/** @function each() - 1105 */
  ...
  //     // function.call(this(=data), arguments[0], arguments[1], arguments[2]);     
